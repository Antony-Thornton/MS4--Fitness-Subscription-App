...
Full website testing can be seen below. For the main README click <a href="https://github.com/Antony-Thornton/MS4--Fitness-Subscription-App/blob/main/README.md" target="_blank">here</a>. Full testing has been conducted AFTER the application was uploaded to Heroku.
...
Contact | 05/06/2022 | Pass | 1 non python related error regarding required element. Because it’s a contact form I need a name and therefore required so the user has to enter something.
...
Add product | 05/06/2022 | Tentative Pass | HTML errors resulting from crispy forms I believe. I could not find the code that wc3 was validating.
Edit product | 05/06/2022 | Tentative Pass | HTML errors resulting from crispy forms I believe. I could not find the code that wc3 was validating.
...
cart.html post load | 05/06/2022 | Pass | 1 warning (ES6)
add_product.html post load | 05/06/2022 | Pass | 1 warning (ES6)
product_detail.html post load | 05/06/2022 | Pass | n/a
products.html post load | 05/06/2022 | Pass | 1 warning (ES6)
profile.html post load | 05/06/2022 | Pass | 1 warning (ES6)
base.html post load | 05/06/2022 | Pass | n/a
...
Exercise Equipment| The 4 links should open to the specified site | Pass | Pass | Pass
...
Clicking on a category should filter all results for that category. | Pass | Pass | Pass | Pass
...
| Expected result | Outcome | Result Desktop | Result iPad | Result S9+ Phone 
| :--- | :--- | :--- | :--- | :---
The page should load with; the image, the name, the price, the description and any reviews found in the database. | In some cases, the image didn’t always load. Usually an issue with added products. Suspect it's a file type/size issue as some additional pictures work and some don’t. | Pass | Pass | Pass
If the super user is logged in an edit and delete product should be visible. Both the links should work. | Pass | Pass | Pass | Pass
If a super user is NOT logged in an edit and delete product should NOT be visible. | Pass | Pass | Pass | Pass
The quantity should not drop below zero | Pass | Pass | Pass | Pass
The quantity buttons should adjust the total up and down | Pass | Pass | Pass | Pass
The keep shopping button should take the user to the whole products page | Pass | Pass | Pass | Pass
